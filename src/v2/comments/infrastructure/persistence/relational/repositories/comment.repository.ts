...
import { CommentAbstractRepository } from '@src/v2/comments/infrastructure/persistence/comment.abstract.repository';
import { CommentEntity } from '@src/v2/comments/infrastructure/persistence/relational/entities/comment.entity';
import { CommentMapper } from '@src/v2/comments/infrastructure/persistence/relational/mappers/comment.mapper';
