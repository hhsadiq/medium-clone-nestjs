...
import { ArticleAbstractRepository } from '@src/v2/articles/infrastructure/persistence/article.abstract.repository';
import { ArticleEntity } from '@src/v2/articles/infrastructure/persistence/relational/entities/article.entity';
import { ArticleMapper } from '@src/v2/articles/infrastructure/persistence/relational/mappers/article.mapper';
