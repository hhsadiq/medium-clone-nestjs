...
import { FilterUserDto, SortUserDto } from '@src/v2/users/dto/query-user.dto';
import { UserEntity } from '@src/v2/users/infrastructure/persistence/relational/entities/user.entity';
import { UserMapper } from '@src/v2/users/infrastructure/persistence/relational/mappers/user.mapper';
import { UserAbstractRepository } from '@src/v2/users/infrastructure/persistence/user.abstract.repository';
...
import { UserSummaryMapper } from '@src/v2/views/infrastructure/persistence/relational/mappers/user.summary.mapper';
